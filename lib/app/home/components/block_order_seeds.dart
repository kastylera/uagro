...
class BlockOrderSeeds extends StatefulWidget {
  ...
  @override
  State<BlockOrderSeeds> createState() => _BlockOrderSeedsState();
}

class _BlockOrderSeedsState extends State<BlockOrderSeeds> {
                      ...
                      Padding(
                        ...
                        child: Row(children: [
                          Padding(
                              ...
                              child: SvgPicture.asset(Assets.seeds, width: 32)),
                          Expanded(
                            child: readText(
                              text:
